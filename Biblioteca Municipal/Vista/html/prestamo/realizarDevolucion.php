    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          <h2>Realizar Devolucion</h2>
          <form id="mcontenido2form" action="index.php?accion=consulsanciones" method="post">
            <table border="1">
              <tr>
                <td>Fecha: </td>
                <td><input type="date" id="autorLibro" name="autorLibro" required></td>
              </tr>
              <tr>
                <td>Usuario: </td>
