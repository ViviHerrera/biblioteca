    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=eliminarLibro" method="post" id="mcontenido2form" style="width: 47%;height: 210px;padding: 35px 40px;">
            <table>
              <tr>
                <td>Codigo: </td>
                <td><input type="text" name="elilicod" id="elilicod"></td>
              </tr>
              <tr>
                <td></td>
                <td><center><input type="submit" name="ingresarAreaEnviar" value="Eliminar" id="ingresarAreaEnviar"></center></td>
                </td>
                </tr>
            </table>
          </form>
