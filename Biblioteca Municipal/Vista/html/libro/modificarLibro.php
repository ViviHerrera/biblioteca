    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=modificarlibro" method="post" id="mcontenido2form" onkeydown="return event.key != 'Enter';" style="width: 47%;height: 210px;padding: 35px 40px;">
            <table>
              <tr>
                <td>Cod. Libro: </td>
                <td><input type="text" name="libomodi" id="libomodi"></td>
              </tr>
              <tr>
                <td colspan="2">
                  <center><input type="submit" name="ingresarLibroEnviar" value="Modificar" id="ingresarLibroEnviar"></center></td>
                </td>
              </tr>
            </table>
          </form>
