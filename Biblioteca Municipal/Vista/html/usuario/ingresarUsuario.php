    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form id="mcontenido2form" action="index.php?accion=guardarUser" method="post" style="width: 50%;padding: 0 40px;">
            <table>
              <tr>
                <td>Documento: </td>
                <td><input type="text" id="codUser" name="codUser" pattern="[0-9]{0,10}" required></td>
              </tr>
              <tr>
                <td>Nombre: </td>
                <td><input type="text" id="nomUser" name="nomUser" required></td>
              </tr>
              <tr>
                <td>Dirección: </td>
                <td><input type="text" id="direUser" name="direUser" required></td>
              </tr>
              <tr>
                <td>Telefóno: </td>
                <td><input type="tel" id="teleUser" name="teleUser"  pattern="[0-9]{10}" required></td>
              </tr>
              <tr>
                <td>Correo: </td>
                <td><input type="text" id="correUser" name="correUser" required></td>
              </tr>
              <tr>
              <td>Estado: </td>
              <td><center>
                <select name="estaUser" id="estaUser" required>
              ...
              <tr>
                <td></td>
                <td><center><input type="submit" name="ingresarUserEnviar" value="Registrar" id="ingresarUserEnviar"></center></td>
              </tr>
            </table>
          </form>
          <img src="Vista/img/user.png" alt="libreria" style="border-radius: -10;width: 38%;height: 94%;margin: -275px -66px;float: right;border-radius: 15px;">
        </article>
      </form>
    </section>
  </div>
