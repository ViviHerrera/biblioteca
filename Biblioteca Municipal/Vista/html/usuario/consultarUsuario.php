    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=consultarusuario" method="post" id="mcontenido2form" onkeydown="return event.key != 'Enter';">
            <table>
              <tr>
                <td>Documento: </td>
                <td><input type="text" name="codigousuario" id="codigousuario"></td>
              </tr>
              <tr>
                
                <td colspan="2">
                  <center><input type="button" value="Consultar" onclick="consultarUsuario()"></center>
                </td>
              </tr>
              
            </table>
            <table style="margin-top:2%;">
            <tr><td colspan="8"><div id="paciente5"></div></td></tr>
            </table>
          </form>
          <img src="Vista/img/consultar.png" alt="libreria" style="border-radius: -10;width: 42%;height: 80%;margin: -247px 4px;float: right;border-radius: 15px;">
