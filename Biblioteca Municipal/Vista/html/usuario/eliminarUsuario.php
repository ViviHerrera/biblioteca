    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=eliminarUsuario" method="post" id="mcontenido2form" style="width: 47%;height: 210px;padding: 35px 40px;">
            <table>
              <tr>
                <td>Documento: </td>
                <td><input type="text" name="eliausucod" id="eliausucod"></td>
              </tr>
              <tr>
                <td colspan="2">
                  <center><input type="button" name="ingresarAreaEnviar" value="Eliminar" id="ingresarAreaEnviar"></center></td>
                </td>
              </tr>
            </table>
          </form>
