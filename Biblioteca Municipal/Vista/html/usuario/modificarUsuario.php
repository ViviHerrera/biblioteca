    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=modificarUsuario" method="post" id="mcontenido2form" onkeydown="return event.key != 'Enter';" style="width: 47%;height: 210px;padding: 35px 40px;">
            <table>
              <tr>
                <td>Documento: </td>
                <td><input type="text" name="usumodi" id="usumodi"></td>
              </tr>
              <tr>
                <td colspan="2">
                  <center><input type="submit" name="ingresarUsuarioEnviar" value="Modificar" id="ingresarUsuarioEnviar"></center></td>
                </td>
              </tr>
            </table>
          </form>
