    ...
    <div id="contenido2">
      <section>
          <article id="mcontenido2">
              <h2>Ingresar área</h2>
              <form id="mcontenido2form" action="index.php?accion=guardarArea" method="post" style="width: 47%;height: 210px;padding: 35px 40px;">
                  <table>
                      <tr>
                          <td>Codigo: </td>
                          <td><input type="text" id="codArea" name="codArea" pattern="[0-9]{0,100}" required></td>
                      </tr>
                      <tr>
                          <td>Nombre: </td>
                      ...
                      <tr>
                          <td colspan="2"><center><input type="submit" name="ingresarAreaEnviar" value="Registrar" id="ingresarAreaEnviar"></center></td>
                      </tr>
                  </table>
              </form>
