    ...
    <div id="contenido2">
      <section>
        <article id="mcontenido2">
          ...
          <form action="index.php?accion=consultararea" method="post" id="mcontenido2form" onkeydown="return event.key != 'Enter';" style="width: 47%;height: 210px;padding: 35px 40px;">
            <table>
              <tr>
                <td>Cod. Área: </td>
                <td><input type="text" name="consultarCodigo" id="consultarCodigo"></td>
              </tr>
              <tr>
                <td colspan="2">
                <center><input type="button" value="Consultar" onclick="consultarArea()"></center>
                </td>
              </tr>
              <tr><td colspan="3"><div id="paciente2"></div></td></tr>
            </table>
          </form>
